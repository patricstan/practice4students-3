...
class WizardNoPrev extends Component
{
    use HasExtraAlpineAttributes;

    protected string $view = 'forms.components.wizard-no-prev';
    ...
    protected function setUp(): void
    {
        ...
        $this->registerListeners([
            'wizard::nextStep' => [
                function (WizardNoPrev $component, string $statePath, string $currentStep): void {
