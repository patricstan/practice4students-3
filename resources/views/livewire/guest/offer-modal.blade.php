<x-layouts.modal>
    <div class="text-justify">
        <div class="flex flex-col items-center bg-white md:flex-row md:max-w-xl dark:bg-gray-800 ">
            <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="{{$offer->company->logo}}" alt="{{$offer->company->company_name}}">
