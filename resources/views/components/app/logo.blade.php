 <a href="{{ route('home') }}" class="flex items-center">
     <div class="mr-3 h-8 scale-75"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="344.564 330.278 111.737 91.218" width="53.87" height="43.61">
             <defs>
